...
$ruleBuilder->register('hasWord', static fn(ClaimInterface $claim) => RAWRule::new(
    static fn(mixed $v): bool|string => is_string($v) && str_contains($v, $seek = $claim->getAttr('word'))
